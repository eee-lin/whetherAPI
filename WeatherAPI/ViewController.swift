...
class ViewController: UIViewController, UISearchBarDelegate {
    ...
    func yoho(searchWord: String) {
        let text = "https://api.openweathermap.org/data/2.5/weather?q=\(searchWord)&units=metric&appid=(自分のAPI)"
    ...
    func tenki () {
        //encorde
        let text = "https://api.openweathermap.org/data/2.5/weather?q=chiba&units=metric&appid=(自分のAPI)".addingPercentEncoding(withAllowedCharacters: .urlQueryAllowed)
